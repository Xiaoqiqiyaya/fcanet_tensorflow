...
def bottleneck(inputs,
  ...
  with tf.variable_scope(scope, 'bottleneck_v1', [inputs]) as sc:
    ...
    hw = residual.shape[2]
    resiudal = fcanet_layer.MultiSpectralAttentionLayer(residual ,depth, hw, hw,reduction=16 , freq_sel_method = 'top2')
